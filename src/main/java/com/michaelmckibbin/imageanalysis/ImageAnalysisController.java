...
//    imageProcessors.add(new UnionFindBlood2(0,0));
...
//
///**
// * Initialize the blood cell image processor and configure its display callback.
// *
// * The TricolourBloodProcessor handles the analysis and processing of blood cell images.
// * A callback is registered to automatically update the UI whenever a new processed
// * image is available.
// *
// * The callback function receives the processed image and updates the imageViewProcessed
// * component in the UI, ensuring that processing results are immediately visible to the user.
// */
//tricolourProcessor = new TricolourBloodProcessor();
//tricolourProcessor.setImageDisplayCallback(image -> {
//    imageViewProcessed.setImage(image);
//});
//
//    UnionFindBlood2 processor = new UnionFindBlood2();
//    processor.setResultCallback(processedImage -> {
//        // Update your UI with the processed image here
...
//
//            } else {
//                sliderBrightness.setValue(0); sliderRed.setValue(100); sliderGreen.setValue(100); sliderBlue.setValue(100);
//            }
//            updateImage();
//        }
//    }
...
//    // Create a list of all sliders
//    List<Slider> sliders = Arrays.asList(
//        sliderBrightness, sliderHue, sliderSaturation, sliderRed, sliderGreen, sliderBlue, sliderWhiteCellSensitivity, sliderRedCellSensitivity, sliderCellSizeThreshold);
//
